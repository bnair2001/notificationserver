...
firebase.initializeApp({
  databaseURL: "https://disastercomms-56253.firebaseio.com",
  serviceAccount: "./disastercomms-56253-firebase-adminsdk-99ipf-1c787261cb.json",
});
  ...
  request(
    {
      ...
      body: JSON.stringify({
        "registration_ids": notificationID, // Ask me for this when u deploy
